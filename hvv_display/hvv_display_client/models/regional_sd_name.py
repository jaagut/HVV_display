...
from ..models.regional_sd_name_type import RegionalSDNameType
from ..models.tariff_details import TariffDetails
from ..types import UNSET, Unset

T = TypeVar("T", bound="RegionalSDName")


@attr.s(auto_attribs=True)
class RegionalSDName:
    """
    Attributes:
        ...
        type (Union[Unset, RegionalSDNameType]):  Default: RegionalSDNameType.UNKNOWN.
    ...
    type: Union[Unset, RegionalSDNameType] = RegionalSDNameType.UNKNOWN
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, RegionalSDNameType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = RegionalSDNameType(_type)
        ...
        regional_sd_name.additional_properties = d
        return regional_sd_name
